...
namespace Common
{
    ...
    public class Task
    {
        ...
        /// </summary>
        public int ErrorRetryCount { get; private set; } = 0;

        /// <summary>
        /// Тайм аут в секундах заданный к повторному повторению в случае сбоя (При условии что  все оберации атомарны)
        /// </summary>
        public int ErrorRetryTimeOutSec { get; private set; } = 0;
