...
{
    /// <summary>
    /// Переменная типа IoBigInt
    /// </summary>
    public class IoBigInt : Param, Common.ParamPlg.ParamTransferSqlI
    {
        /// <summary>
        /// Значение параметра
        /// </summary>
        public Int64 ParamValue;
        ...
        public IoBigInt() : base(Assembly.GetExecutingAssembly().FullName, Assembly.GetExecutingAssembly().GetName().Version.ToString())
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                this.EventSave(ae.Message, string.Format("{0}.IoBigInt", this.GetType().FullName), EventEn.Error);
                throw ae;
            }
        }
