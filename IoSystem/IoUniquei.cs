...
{
    /// <summary>
    /// Переменная типа IoUniquei
    /// </summary>
    public class IoUniquei : Param, Common.ParamPlg.ParamTransferSqlI
    {
        /// <summary>
        /// Значение параметра
        /// </summary>
        public Guid ParamValue;
        ...
        public IoUniquei() : base(Assembly.GetExecutingAssembly().FullName, Assembly.GetExecutingAssembly().GetName().Version.ToString())
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                this.EventSave(ae.Message, string.Format("{0}.IoUniquei", this.GetType().FullName), EventEn.Error);
                throw ae;
            }
        }
