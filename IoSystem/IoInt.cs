...
{
    /// <summary>
    /// Переменная типа IoInt
    /// </summary>
    public class IoInt : Param, Common.ParamPlg.ParamTransferSqlI
    {
        /// <summary>
        /// Значение параметра
        /// </summary>
        ...
        public IoInt() : base(Assembly.GetExecutingAssembly().FullName, Assembly.GetExecutingAssembly().GetName().Version.ToString())
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                this.EventSave(ae.Message, string.Format("{0}.IoInt", this.GetType().FullName), EventEn.Error);
                throw ae;
            }
        }
